...
public class GroupeRessources {
	...
	public GroupeRessources(VM vm,int type){
		...
		if(type==0){
			...
			index=VariablesGlobales.indexressourcestez;
			VariablesGlobales.indexressourcestez++;
		}
		this.setLibre();
	}
	...
	public void setLibre(){
		disponibilite=1;
		ordreLiberation=VariablesGlobales.ordreLiberation;
		VariablesGlobales.ordreLiberation+=1;
	}
